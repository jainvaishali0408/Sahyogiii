...
class VitalHome extends StatefulWidget {
  const VitalHome({super.key});

  @override
  State<VitalHome> createState() => _VitalHomeState();
}

class _VitalHomeState extends State<VitalHome> {
