...
import 'package:sahyogii/med_rem/global_bloc.dart';
import 'package:sahyogii/med_rem/models/errors.dart';
import 'package:sahyogii/med_rem/models/medicine.dart';
import 'package:sahyogii/med_rem/pages/home_page.dart';
import 'package:sahyogii/med_rem/pages/new_entry/new_entry_bloc.dart';
import 'package:sahyogii/med_rem/pages/success_screen/success_screen.dart';
    ...
    for (int i = 0; i < (24 / medicine.interval!).floor(); i++) {
      ...
      await flutterLocalNotificationsPlugin.zonedSchedule(
        ...
        medicine.medicineType.toString() != MedicineType.None.toString()
            ? 'It is time to take your ${medicine.medicineType!.toLowerCase()}, according to schedule'
            : 'It is time to take your medicine, according to schedule',
        _nextInstanceOfTime(hour, minute, medicine.interval! * i),
        platformChannelSpecifics,
...
tz.TZDateTime _nextInstanceOfTime(int hour, int minute, int day) {
  ...
  return scheduledDate.add(Duration(days: day));
}
